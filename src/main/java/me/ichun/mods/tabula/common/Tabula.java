...
import me.ichun.mods.tabula.common.core.Config;
import me.ichun.mods.tabula.common.core.EventHandler;
...
public class Tabula
{
    ...
    public static final String VERSION = iChunUtil.VERSION_MAJOR + ".0.110";
